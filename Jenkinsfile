...
node {
  withEnv(['AZURE_SUBSCRIPTION_ID=e9a5817b-a6ea-44dc-b95b-bd6a9371aef1',
    ...
    stage('deploy') {
      ...
      // login Azure
      withCredentials([usernamePassword(credentialsId: 'd9da1349-763f-4809-b1f8-54282e69d488', passwordVariable: 'ahntr7LtJBn9_n02AtSA1WQf08sDOpBn1G', usernameVariable: 'http://SangramJavaApp')]) {
       sh '''
